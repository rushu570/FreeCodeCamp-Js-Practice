...
void solve(){
    ...
    s->top=-1;
    s->arr=new int[s->size];
   cout<<"Pushing this element "<< push(s,1)<<endl;
    cout<<"Pushing this element "<<push(s,2)<<endl;
    cout<<"Pushing this element "<<push(s,3)<<endl;
   cout<<"Pushing this element " <<push(s,4)<<endl;
   cout<<"Pushing this element " <<push(s,5)<<endl;
   cout<<"Pushing this element " <<push(s,6)<<endl;
    if(isEmpty(s)){
    ...
    cout<<"Removing this element "<<pop(s)<<endl;
